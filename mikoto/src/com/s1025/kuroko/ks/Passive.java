...
import com.s1025.kuroko.model.resp.Media;
import com.s1025.kuroko.model.resp.MediaMusic;
import com.s1025.kuroko.model.resp.MediaVideo;
import com.s1025.kuroko.model.resp.RespArticle;
import com.s1025.kuroko.model.resp.RespImg;
import com.s1025.kuroko.model.resp.RespMusic;
import com.s1025.kuroko.model.resp.RespNews;
import com.s1025.kuroko.model.resp.RespText;
import com.s1025.kuroko.model.resp.RespVideo;
import com.s1025.kuroko.model.resp.RespVoice;
...
public class Passive {
	...
	public void sendRespText(ReqBase reqBase, String content, HttpServletResponse resp) throws IOException{
		...
		String xml = parse.RespToXML(respText);
	...
	public void sendRespImg(ReqBase reqBase, String mediaId, HttpServletResponse resp) throws IOException{
		...
		String xml = parse.RespToXML(respImg);
		resp.setCharacterEncoding("UTF-8");
		PrintWriter out = resp.getWriter();
		out.write(xml);
		out.close();
	...
	public void sendRespVoice(ReqBase reqBase, String mediaId, HttpServletResponse resp) throws IOException{
		...
		String xml = parse.RespToXML(respVoice);
		resp.setCharacterEncoding("UTF-8");
		PrintWriter out = resp.getWriter();
		out.write(xml);
		out.close();
	...
	public void sendRespVideo(ReqBase reqBase, String mediaId, String title, String desc, HttpServletResponse resp) throws IOException{
		...
		String xml = parse.RespToXML(respVideo);
		resp.setCharacterEncoding("UTF-8");
		PrintWriter out = resp.getWriter();
		out.write(xml);
		out.close();
	...
	public void sendRespMusic(ReqBase reqBase, String title, String desc, String musicUrl, String hQMusicUrl, String thumb, HttpServletResponse resp) throws IOException{
		...
		String xml = parse.RespToXML(respMusic);
		resp.setCharacterEncoding("UTF-8");
		PrintWriter out = resp.getWriter();
		out.write(xml);
		out.close();
	...
	public void sendRespNews(ReqBase reqBase, int count, List<RespArticle> articles, HttpServletResponse resp) throws IOException{
		...
		String xml = parse.RespToXML(respNews);
		resp.setCharacterEncoding("UTF-8");
		PrintWriter out = resp.getWriter();
